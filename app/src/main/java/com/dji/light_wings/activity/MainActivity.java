package com.dji.light_wings.activity;
...
import com.dji.light_wings.R;
import com.dji.light_wings.tool.VirtualStick;
import com.dji.light_wings.tool.VirtualStickApplication;
...
public class MainActivity extends Activity implements SurfaceTextureListener, View.OnTouchListener,View.OnClickListener{
    //用于记录第一次点击返回按钮时间
    ...
    private void refresh() {
        {
            ...
            if(mProduct != null && mProduct.isConnected()) {
                ...
                try{
                    ...
                    Toast.makeText(MainActivity.this,"1"+e.toString(),Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
                ...
                try {
                    ...
                    Toast.makeText(MainActivity.this,"2"+e.toString(),Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
                ...
                try{
                    ...
                    Toast.makeText(MainActivity.this,"3"+e.toString(),Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
                ...
                try{
                    ...
                    Toast.makeText(MainActivity.this,"4"+e.toString(),Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
                ...
                try{
                    ...
                    Toast.makeText(MainActivity.this,"5"+e.toString(),Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
...
//        setContentView(new MyView(this));
    ...
    private void initUI() {
        ...
        //获取释放权限、起飞降落按钮初始化
        enableButton=(Button) findViewById(R.id.enableButton);disableButton=(Button) findViewById(R.id.disableButton);
        enableButton.setOnClickListener(this); disableButton.setOnClickListener(this);
        infoLayout =  (LinearLayout)findViewById(R.id.info);

        //takeOffButton=(Button) findViewById(R.id.takeOffButton);landButton=(Button) findViewById(R.id.landButton);
        //takeOffButton.setOnClickListener(this);landButton.setOnClickListener(this);
        ...
        try{
            switch(v.getId()){
                case R.id.enableButton: {
                    if(infoLayout.getVisibility() == v.GONE ){
                        infoLayout.setVisibility(v.VISIBLE);
                    }
                    break;
                }
                case R.id.disableButton: {
                    if(infoLayout.getVisibility() == v.VISIBLE){
                    ...
                    try {
                       ...
                       //dataText.setText(data);
                        ...
                        if(mProduct != null && mProduct.isConnected()){
                            ...
                            //VirtualStickApplication.logInfo(result);
                        }else{
